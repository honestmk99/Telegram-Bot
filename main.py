...
def start(update, context):
  ...
  if usa == "1926801217" or usa == "1394902938" or usa =="5791144147" :#5515451493
    ...
    if len(jobs) ==0:
        ...
        conn.commit() 
    keyboard =[  [InlineKeyboardButton("⚙️ ADD Category", callback_data="90"),InlineKeyboardButton("⚙️ Delete Category", callback_data="del")],
                 [InlineKeyboardButton("➕ Subcat Category", callback_data="90a"),InlineKeyboardButton("❌ Sub category", callback_data="dela")],
                   [InlineKeyboardButton("➕ Product", callback_data="1"),InlineKeyboardButton("❌ Product", callback_data="2")],  
                ...
                [InlineKeyboardButton("ADD wallet address", callback_data="189"),InlineKeyboardButton("Delete wallet address", callback_data="d189")],
                [InlineKeyboardButton("FAQ", callback_data="faq"),InlineKeyboardButton("DEL FAQ", callback_data="dfaq")],
                [InlineKeyboardButton("Withdrawl Req", callback_data="owth"),InlineKeyboardButton("User Wallets", callback_data="uwal")],
                [InlineKeyboardButton("Withdrawl History", callback_data="wh")]]
    ...
    return BUTTON
      ...
      if len(jobs) ==0:
          ...
          cursor = connection.cursor() 
          cursor.execute("INSERT INTO COMPANY (ID,balance,link,code,amount,name,withdrawl,wemail,ct,sct,email,Trx,exp,naam,wname,opt,ttr,twd) \
            VALUES ({}, '{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')".format(int(user),"0","0","0","0",usaf,"0","0","0","0","0","0","0",usaf,usaf,"0","0","0"))
          connection.commit()
          connection.close()
      ...
      context.bot.send_message(chat_id=update.effective_user.id,text='Send Your Language',reply_markup=reply_markup)
      return BUTTON
def button(update, context):
    ...
    if a== 'french':
      ...
      context.bot.send_message(chat_id=update.effective_user.id,text="Bienvenue sur le tableau de bord utilisateur",reply_markup=reply_markup)
        ...
        cursor = connection.cursor()  
        cursor.execute("SELECT address FROM COMPANY")
        keyf=[]
        for name in cursor:
        ...
        keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text='Send FAQs Questions',reply_markup=reply_markup)
        return FIKA
    elif a== 'dfaq':
        ...
        keyf.append(b)
        reply_markup = InlineKeyboardMarkup(keyf,resize_keyboard=True,one_time_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text="Select question to delete",reply_markup=reply_markup) 
        return DFAQ
    elif a== '913':
        keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
        ...
        jobs = cursor.fetchall()
        if len(jobs) !=0:
            f = open("withdrawl.txt", "w",encoding="utf-8")
            conn = sqlite3.connect('withdraw.db') 
      ...
      if len(jobs) !=0:
        ...
        keyf.append(b)
        reply_markup = InlineKeyboardMarkup(keyf,resize_keyboard=True,one_time_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text="Select Withdrawl Request",reply_markup=reply_markup) 
        return WWRR
      else:
        ...
        keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text='Send name for your wallet',reply_markup=reply_markup)
        return UOL
    elif a== '1with':
        conn = sqlite3.connect('wallet.db')
        ...
        if qoop==0:
          ...
          reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
          context.bot.send_message(chat_id=update.effective_user.id,text="Sorry You don't have enough balance to withdraw",reply_markup=reply_markup)
        else:
          keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="200")]]
          reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
          context.bot.send_message(chat_id=update.effective_user.id,text="Send amount you want to withdraw",reply_markup=reply_markup)   
          return DBS 
    elif a== '1withf':
        conn = sqlite3.connect('wallet.db')
        cursor = conn.execute("SELECT balance from COMPANY where ID= {}   ".format(int(update.effective_user.id))) 
      ...
      return DELETE
        ...
        keyf.append(b)
        reply_markup = InlineKeyboardMarkup(keyf,resize_keyboard=True,one_time_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text="Select Category to delte",reply_markup=reply_markup) 
        return BEL
    elif a=="dela":      
        keyf=[]
        ...
        for name in cursor:
          tqp=float(name[0])
        if dffr==tqp:
          keyboard =[[InlineKeyboardButton("➕ Add to cart", callback_data="16"),InlineKeyboardButton("🔙 Cancel", callback_data="200")],[InlineKeyboardButton("➕ Quantity", callback_data="161")]]
          reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
          context.bot.edit_message_caption(chat_id=update.effective_user.id,message_id=cf,caption=cc,reply_markup=reply_markup)
          context.bot.send_message(chat_id=update.effective_user.id,text=' You Reached maximum allowed quantity')  
          ...
          keyboard =[[InlineKeyboardButton("➕ Add to cart", callback_data="16"),InlineKeyboardButton("🔙 Cancel", callback_data="200")],[InlineKeyboardButton("➕ Quantity", callback_data="160"),InlineKeyboardButton("➖ Quantity", callback_data="161")]]
          reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
          context.bot.edit_message_caption(chat_id=update.effective_user.id,message_id=cf,caption=cc,reply_markup=reply_markup)
      ...
      context.bot.send_message(chat_id=update.effective_user.id,text=welcome,reply_markup=reply_markup)
        ...
        keyboard =[[InlineKeyboardButton("🔙 Main Menu", callback_data="200")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text="Cart cleared",reply_markup=reply_markup) 
        return BUTTON
    elif a== '29s':
        cc=update.callback_query.message.caption
        fg=cc
        ...
        keyboard =[[InlineKeyboardButton("🔙 Menú principal", callback_data="spanish")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text="Carro vaciado",reply_markup=reply_markup) 
        return BUTTON
    elif a== '29f':
        cc=update.callback_query.message.caption
        fg=cc
        ...
        keyboard =[[InlineKeyboardButton("🔙 Menu principal", callback_data="french")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text="Panier vidé",reply_markup=reply_markup) 
        return BUTTON
    elif a=='1bal':
            connection = sqlite3.connect("deposit.db")  
            cursor = connection.cursor()  
            ...
            keyf.append(b)
            reply_markup = InlineKeyboardMarkup(keyf,resize_keyboard=True,one_time_keyboard=True)
            context.bot.send_message(chat_id=update.effective_user.id,text="Select Wallet to get details",reply_markup=reply_markup) 
            return BYE
    elif a=='1bals':
            connection = sqlite3.connect("deposit.db")  
            cursor = connection.cursor()  
        ...
        keyboard = [[InlineKeyboardButton("🔙 Main Menu", callback_data='200')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        context.bot.send_message(chat_id=update.effective_user.id,text="Send Screenshot of payment proof. Thanks",reply_markup=reply_markup) 
...
def wwrr(update,context):
    ...
    if msg=='MAINN':
      ...
      for row in cursor: 
          ...
          keyboard =[[InlineKeyboardButton("Accept", callback_data="120a"),InlineKeyboardButton("Reject", callback_data="130a")],[InlineKeyboardButton("🔙 Cancel", callback_data="100")]]
          reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
...
def penord(update,context):
    ...
    if msg=="🔙Back":
      ...
      return HAM 
        ...
        conn = sqlite3.connect('orders.db')
        cursor = conn.execute("SELECT ID,price,quantity,status,pnam,oid,date,address,name,time from COMPANY where oid ='{}'".format(msg))
        conn.commit()
        for row in cursor: 
            g="\nDate:  "+row[6]+"\nTime: "+row[9]+"\nUserID:  "+row[0]+"\nEmail:  "+row[7]+"\nProduct Name: "+row[4]+"\nPrice: "+row[1]+"\nOrderID: "+row[5]+"\nOrder Status: "+row[3]+"\n\n"
...
def dbsf(update,context):
  ...
  try:
    ...
    if float(msg)>=qoop:
      keyboard =[[InlineKeyboardButton("🔙 Menu principal", callback_data="french")]]
      reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
      context.bot.send_message(chat_id=update.effective_user.id,text="Désolé, vous ne pouvez pas retirer ce montant. Essayez avec moins de quantité. Merci",reply_markup=reply_markup)
      return DBSF
    else:
      conn = sqlite3.connect("wallet.db")  
      conn.execute("UPDATE COMPANY set link = '{}' where ID = {}".format(msg,int(update.effective_user.id)))
      ...
      keyboard =[[InlineKeyboardButton("🔙 Menu principal", callback_data="french")]]
      reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
      context.bot.send_message(chat_id=update.effective_user.id,text="Indiquez votre adresse de portefeuille pour recevoir ce montant",reply_markup=reply_markup)   
      return CUITF
  except:
      keyboard =[[InlineKeyboardButton("🔙 Menu principal", callback_data="french")]]
      reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
      context.bot.send_message(chat_id=update.effective_user.id,text="Envoyer en chiffres uniquement",reply_markup=reply_markup)   
      return DBSF
def cuit(update,context):
    ...
    keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="200")]]
    reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
    context.bot.send_message(chat_id=update.effective_user.id,text="Provide your email address",reply_markup=reply_markup)   
    return CUI#DBSF,CUIF,CUITF
...
def cui(update,context):
    ...
    connection = sqlite3.connect("wallet.db")  
    cursor = connection.cursor()  
    cursor.execute("SELECT link,balance,code FROM COMPANY where id= {}".format(int(update.effective_user.id)) )
    for row in cursor:
      print(row[0])
      today = date.today()
      ...
      conn = sqlite3.connect('withdraw.db')
      conn.execute("INSERT INTO COMPANY (ID,balance,status,wid,email,rid,date,time,address) \
                          VALUES ('{}', '{}','{}', '{}','{}','{}', '{}','{}','{}')".format(str(update.effective_user.id),row[1],"Pending",row[0],msg,yu,d1,current_time,row[2]))
      conn.commit()
      keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="200")]]
      reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
      context.bot.send_message(chat_id=update.effective_user.id,text="Withdrawl Request submitted" ,reply_markup=reply_markup)
      return BUTTON 
def cuif(update,context):
    ...
    for row in cursor:
      ...
      keyboard =[[InlineKeyboardButton("🔙 Menu principal", callback_data="french")]]
      reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
      context.bot.send_message(chat_id=update.effective_user.id,text="Demande de retrait soumise" ,reply_markup=reply_markup)
      return BUTTON     
def ham(update,context):
  ...
  if msg=="⏳ - PENDING":
        ...
        if len(jobs) !=0:
            ...
            conn = sqlite3.connect('orders.db') 
            cursor = conn.execute("SELECT ID,price,quantity,status,pnam,oid,date,address,name,time from COMPANY ")
            conn.commit()
            xa="Orders\n"
            i=0
            j=0
...
def address(update,context):
    ...
    for row in cursor:
        ...
        conn.close()
        conn = sqlite3.connect('orders.db')
        conn.execute("INSERT INTO COMPANY (ID,name,price,oid,address,date,quantity,pnam,productID,status,opt,contact,time) \
                VALUES ('{}', '{}','{}', '{}', '{}', '{}', '{}','{}','{}','{}','{}','{}','{}')".format(str(update.effective_user.id),ms,deepe,str(v),rdusd,dat,wqp,naak,sib,"pending",rdrt,msg,current_time)) 
        conn.commit()
    conn = sqlite3.connect('cart.db')
...
def addressf(update,context):
    ...
    cursor = conn.execute("DELETE  from COMPANY where ID= '{}'".format(str(update.effective_user.id)))
    conn.commit()
    keyboard =[[InlineKeyboardButton("🔙 Retour", callback_data="french")]]
    reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
...
def proft(update,context):
    ...
    keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="200")]]
    reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
    context.bot.send_message(chat_id=update.effective_user.id,text='Thank you. Admin will accept/reject ASAP',reply_markup=reply_markup)
...
def uol(update,context):
    ...
    keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
    reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
    context.bot.send_message(chat_id=update.effective_user.id,text='wallet Name has been updated',reply_markup=reply_markup)
    return BUTTON
...
def depot(update,context):
    ...
    keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
    reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
    context.bot.send_message(chat_id=update.effective_user.id,text='Wallet Address updated',reply_markup=reply_markup)
    return BUTTON    
...
def wall(update,context):
    ...
    try:
        ...
        keyboard = [[InlineKeyboardButton("I have Paid", callback_data='999z')],[InlineKeyboardButton("Make a Payment", url=url)],
                    [InlineKeyboardButton("🔙 Cancel Transcation", callback_data='12')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        user=int(update.effective_user.id)
...
def jos(update,context):
    ...
    if msg=="📝️ Products":
        ...
        if len(jobs) !=0:
            ...
            keyboard = [[InlineKeyboardButton("🔙 Menu principal", callback_data='french')]]
            reply_markup = InlineKeyboardMarkup(keyboard)
            context.bot.send_message(chat_id=update.effective_user.id,text="Le panier est vide",reply_markup=reply_markup)                       
            return BUTTON
    elif msg=="💳 Wallet":
        conn = sqlite3.connect('wallet.db')
        ...
        keyboard = [[InlineKeyboardButton("➕ Add Funds", callback_data='1bal'),InlineKeyboardButton("💸 Withdrawl", callback_data='1with')],[InlineKeyboardButton("Create Name of Walet", callback_data='90p'),InlineKeyboardButton("🔙 Main Menu", callback_data='200')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        ...
        keyboard = [[InlineKeyboardButton("➕ Añadir fondos", callback_data='1bals'),InlineKeyboardButton("💸 Retirar", callback_data='1withs')]
           ,[InlineKeyboardButton("Crear nombre de billetera", callback_data='90ps'),InlineKeyboardButton("🔙 Menú principal", callback_data='spanish')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        ...
        for row in cursor:
          ...
          keyboard =[[InlineKeyboardButton("🌎Main Menu", callback_data="200")]]
          reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
          context.bot.send_message(chat_id=update.effective_user.id,text=aaa,reply_markup=reply_markup)
          return BUTTON
        ...
        keyboard =[[InlineKeyboardButton("🌎Main Menu", callback_data="200")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text=jkl,reply_markup=reply_markup)
        return BUTTON
    elif msg=="🙋 FAQs":
        connection = sqlite3.connect("faqs.db")  
        cursor = connection.cursor()  
        ...
        if len(jobs) !=0:
                    ...
                    for row in cursor:
                        if row[1]=="pending":
                            ...
                            k="❌"
                        c=[InlineKeyboardButton(k+row[2], callback_data=row[0])]
                        keyf.append(c)
                    b=[InlineKeyboardButton("🌎Main Menu", callback_data='🌎Main Menu')]
                    keyf.append(b)
                    reply_markup = InlineKeyboardMarkup(keyf,resize_keyboard=True,one_time_keyboard=True)
          ...
          keyboard =[[InlineKeyboardButton("🌎Main Menu", callback_data="200")]]
          reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
          context.bot.send_message(chat_id=update.effective_user.id,text="You Have Not Made Any Orders",reply_markup=reply_markup)
          return BUTTON
        ...
        if len(jobs) !=0:
          ...
          keyboard =[[InlineKeyboardButton("🌎Menú principal", callback_data="spanish")]]
          reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
          context.bot.send_message(chat_id=update.effective_user.id,text="No has hecho ningún pedido",reply_markup=reply_markup)
          return BUTTON
      ...
      if len(jobs) !=0:
        ...
        keyboard =[[InlineKeyboardButton("🌎Menu principal", callback_data="french")]]
        reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True)
        context.bot.send_message(chat_id=update.effective_user.id,text="Vous n'avez passé aucune commande",reply_markup=reply_markup)
        return BUTTON
...
def pida(update,context):
    ...
    for name in cursor:
        ...
        keyf.append(cv)
    reply_markup = ReplyKeyboardMarkup(keyf,resize_keyboard=True)
    context.bot.send_message(chat_id=update.effective_user.id,text="Select the sub category",reply_markup=reply_markup)  
    return PID
...
def typp(update,context):
    ...
    keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
    reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
    context.bot.send_message(chat_id=update.effective_user.id,text='Send max quality a user can buy',reply_markup=reply_markup)
    return MADDA
def madda(update,context):
    ...
    keyboard =[[InlineKeyboardButton("🔙 Back", callback_data="100")]]
    reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True,one_time_keyboard=True)
    context.bot.send_message(chat_id=update.effective_user.id,text='Send total quantities of  Product in stock, Should be a number',reply_markup=reply_markup)
    return MADD
def madd(update,context):
    ...
    try:
      msg=int(msg)
      conn = sqlite3.connect('shop.db')
      conn.execute("INSERT INTO COMPANY (name,description,price,productID,photoid,category,subcat,max,stock) \
